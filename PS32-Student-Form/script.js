const validators = {
  ...
  dob: {
    ...
    errEl: document.getElementById("dobErr"),
    fn: (v) => {
...
document
  ...
  .addEventListener("click", () => {
    pwdEl.type =
      pwdEl.type === "password" ? "text" : "password";
  });
document
  ...
  .addEventListener("submit", (e) => {
    ...
    Object.values(validators).forEach((v) => {
      if (!validateField(v)) valid = false;
    });
