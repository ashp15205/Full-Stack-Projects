...
function switchPlan() {
  ...
  document.getElementById("mLabel").className = yearly
    ? "text-secondary fw-bold"
    : "fw-bold text-white";
  document.getElementById("yLabel").className = yearly
    ? "fw-bold text-white"
    : "text-secondary";
  render();
}
...
function render() {
  document.getElementById("cards").innerHTML = plans
    .map(
      (
        p,
      ) => `<div class="col-md-4"><div class="plan-card ${p.featured ? "featured" : ""}">
