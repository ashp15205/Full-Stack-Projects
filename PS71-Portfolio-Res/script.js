...
const projects = [
  {
    name: "MERN Blog",
    desc: "Full-stack blog with auth and CRUD",
    tag: "MERN",
  },
  {
    name: "Weather Dashboard",
    desc: "Chart.js weather trend visualizer",
    tag: "Chart.js",
  },
  {
    name: "Task Manager",
    desc: "Kanban board with localStorage",
    tag: "Vanilla JS",
  },
];

// Render skill bars
document.getElementById("skill-bars").innerHTML = skills
  .map(
    (s) => `
