const images = [
  ...
  {id:4, emoji:'🎨', title:'Color Burst', desc:'Abstract expressionist composition', cat:'abstract'},
  {id:5, emoji:'🌸', title:'Cherry Blossoms', desc:'Spring sakura in Tokyo', cat:'nature'},
  {id:6, emoji:'🏛', title:'Ancient Columns', desc:'Greco-Roman temple facade', cat:'architecture'},
  {id:7, emoji:'👩‍💻', title:'Developer', desc:'Late night coding session', cat:'people'},
  {id:8, emoji:'🌌', title:'Galaxy', desc:'Milky Way time-lapse', cat:'abstract'},
  {id:9, emoji:'🌿', title:'Forest Path', desc:'Morning mist through redwoods', cat:'nature'},
  {id:10, emoji:'🗼', title:'Eiffel Tower', desc:'Parisian icon at night', cat:'architecture'},
  {id:11, emoji:'🎭', title:'Street Performer', desc:'Mime on Place du Tertre', cat:'people'},
  {id:12, emoji:'💫', title:'Nebula', desc:'Deep space Hubble capture', cat:'abstract'},
  {id:13, emoji:'🏔', title:'Glacier Lake', desc:'Crystal clear alpine waters', cat:'nature'},
  {id:14, emoji:'🏗', title:'Bridge Construction', desc:'Engineering marvel under build', cat:'architecture'},
  {id:15, emoji:'👨‍🎨', title:'Artist at Work', desc:'Studio painting session', cat:'people'},
];
